...
export const Mutations = {
  ...
  // App configuration
  SET_APP_ALL_OPTIONS: 'SET_APP_ALL_OPTIONS',
...
export const Mutators = {
  ...
  [Mutations.SET_APP_ALL_OPTIONS](state, { id, options }) {
    state.options.extension.apps = state.options.extension.apps || {};
    state.options.extension.apps[id] = _.extend(state.options.extension.apps[id], options.extension);

    state.options.channel.apps = state.options.channel.apps || {};
    state.options.channel.apps[id] = _.extend(state.options.channel.apps[id], options.channel);

    state.options.viewer.apps = state.options.viewer.apps || {};
    state.options.viewer.apps[id] = _.extend(state.options.viewer.apps[id], options.viewer);
